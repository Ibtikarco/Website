...
const ProjectsChart = () => {
  ...
  return (
    <div className="bg-white p-12 md:p-14 lg:p-16 mx-8 md:mx-12 lg:mx-16 rounded-lg shadow-xl border-4 border-[#5d9cc3] overflow-hidden">
      <h3 className="text-2xl md:text-3xl font-bold text-[#3e738f] mb-8 md:mb-10 text-center">
        تنوع المشاريع
      </h3>
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-12 lg:gap-16 px-6">
        {/* Custom Legend on the right */}
        <div className="w-full md:flex-1 space-y-4 md:max-w-[220px]">
          {chartData.map((item, index) => (
            ...
            >
              ...
              ></div>
              <span className={`text-base md:text-lg font-bold whitespace-nowrap transition-all duration-200 ${
