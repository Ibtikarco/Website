    ...
    <section id="about" className="py-20 bg-white" dir="rtl">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={stat.id}
                className="bg-gradient-to-br from-[#3e738f] to-[#5d9cc3] p-8 text-center transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-8 border-r-4 border-[#5d9cc3] hover:shadow-lg transition-shadow">
            <h3 className="text-2xl font-bold text-[#3e738f] mb-4">رؤيتنا</h3>
            <p className="text-[#696867] leading-relaxed">{companyInfo.vision}</p>
          </div>
          <div className="bg-gray-50 p-8 border-r-4 border-[#3e738f] hover:shadow-lg transition-shadow">
        ...
        {/* CEO Message */}
        <div className="mt-16 bg-gradient-to-br from-[#3e738f] to-[#5d9cc3] p-8 md:p-12 text-white">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-start gap-6">
              <div className="hidden md:block w-32 h-32 bg-white/20 rounded-full flex-shrink-0"></div>
              <div>
                <h3 className="text-2xl font-bold mb-2">{companyInfo.ceo.name}</h3>
                <p className="text-gray-100 mb-4 text-lg">{companyInfo.ceo.title}</p>
