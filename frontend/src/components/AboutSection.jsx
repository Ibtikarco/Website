          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8">
              ...
              <a 
                ...
                className="bg-[#1F4F6D] text-[#888] hover:bg-[#5d9cc3] hover:text-white border-2 border-[#1F4F6D] hover:border-[#5d9cc3] px-8 py-4 transition-all duration-300 shadow-lg font-semibold flex items-center gap-2 whitespace-nowrap"
              >
