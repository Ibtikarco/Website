...
export const projects = [
  ...
  },
  {
    ...
    ownerEn: 'King Abdulaziz University',
    ...
    designOfficeEn: 'Hakim Consultancy',
    completion: '100%',
    briefTitle: 'إنشاء وتشطيب مبنى بارتفاع 7 طوابق',
    briefTitleEn: 'Construction and Finishing of 7-Story Building',
    ...
    briefEn: 'Seven-story building containing basement, parking lots and other services.\n\nScope of work includes execution and supply of all structural, architectural and electromechanical works, safety systems, waterproofing and thermal insulation works.'
  },
  {
    id: 12,
    title: 'العزيزية كمباوند',
    titleEn: 'Al-Aziziyah Compound',
    category: 'سكني',
    categoryEn: 'Residential',
    location: 'حي الدفاع - المدينة المنورة',
    locationEn: 'Al-Difa District - Madinah',
    area: '1,500 م²',
    areaEn: '1,500 m²',
    value: '4 مليون',
    valueEn: '4 Million',
    ...
    statusEn: 'Completed',
    type: 'تطوير عقاري',
    typeEn: 'Real Estate Development',
