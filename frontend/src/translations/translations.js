export const translations = {
  ar: {
    ...
    // Services
    ourServices: 'خدماتنا',
    servicesDescription: 'نحرص على تركيز اهتمامنا علعلى كل تفاصيل المشروع بداية من أعمال المساحة وتحديد المناسيب حتى الإنتهاء من التنفيذ وتسليم المشروع للعميل',
