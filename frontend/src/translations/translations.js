export const translations = {
  ar: {
    ...
    service1: 'التصميم والمخططات الهندسية',
    service2: 'الإنشاء والتنفيذ',
    service3: 'الصيانة والتشغيل',
    service4: 'إدارة المشاريع',
    service5: 'الاستشارات الهندسية',
    service6: 'أعمال التشطيبات',
